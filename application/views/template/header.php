        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="<?php echo base_url('designation/report'); ?>">Designation</a></li>
                        <li><a href="<?php echo base_url('relation/report'); ?>">Relations</a></li>
                        <!-- <li><a href="<?php //echo base_url('division/report'); ?>">Division</a></li>
                        <li><a href="<?php //echo base_url('district/report'); ?>">District</a></li>
                        <li><a href="<?php //echo base_url('branch/report'); ?>">Sonali Bank Branches</a></li> -->
                    </ul>
                </li>
            </ul>            
        </div>
